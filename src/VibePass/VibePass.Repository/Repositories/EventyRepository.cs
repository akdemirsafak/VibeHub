...
public class EventyRepository : BaseRepository, IEventyRepository
{
    ...
    {
        var command = @"INSERT INTO Events (Title, Description, StartDate, EndDate, Location, ImageUrl, CreatedAt) 
            VALUES (@Title, @Description, @StartDate, @EndDate, @Location,@ImageUrl, @CreatedAt) RETURNING *";
    ...
    public async Task<int> DeleteByIdAsync(string id)
    {
        ...
        var record = await _dbConnection.QueryFirstOrDefaultAsync<EventyResponse>("Select * from Events Where Id=@id", id);
    ...
    {
        var record = await _dbConnection.QueryFirstOrDefaultAsync<Eventy>("Select * from Events Where Id=@id", id);
        DynamicParameters queryParameters = new DynamicParameters();
        queryParameters.Add("Id", id);
        queryParameters.Add("Title", entity.Title);
        queryParameters.Add("Description", entity.Description);
